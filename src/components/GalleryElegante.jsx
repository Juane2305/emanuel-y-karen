    ...
    <div className="w-full max-w-3xl mx-auto py-8 px-4 text-center text-white relative">
      ...
      >
        ...
        <button
          onClick={prevSlide}
          className={`
            absolute left-2 top-1/2 transform -translate-y-1/2 text-white px-2 py-1 rounded z-30 bg-gold
            ${buttonStyle}
          `}
        >
          ❮
        ...
        <button
          onClick={nextSlide}
          className={`
            absolute right-2 top-1/2 transform -translate-y-1/2 text-white px-2 py-1 rounded z-30 bg-gold
            ${buttonStyle}
          `}
        >
          ❯
